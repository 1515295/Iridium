...
This document provides guidelines for internationalization of the Iridium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `iridium_en.ts` remains unchanged.
