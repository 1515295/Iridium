...
#ifndef IRIDIUM_QT_IRIDIUMUNITS_H
#define IRIDIUM_QT_IRIDIUMUNITS_H
...
/** Iridium unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class IridiumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit IridiumUnits(QObject *parent);

    /** Iridium units.
      @note Source: https://en.iridium.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        IRD,
...
typedef IridiumUnits::Unit IridiumUnit;

#endif // IRIDIUM_QT_IRIDIUMUNITS_H
