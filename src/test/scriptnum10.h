...
#ifndef IRIDIUM_TEST_SCRIPTNUM10_H
#define IRIDIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Iridium Core 0.10.0, for cross-comparison.
 */
public:
