...
By default, iridiumd will dump mempool on shutdown and
...
class MempoolPersistTest(IridiumTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give iridiumd a second to reload the mempool
        ...
        self.log.debug("Prevent iridiumd from writing mempool.dat to disk. Verify that `savemempool` fails")
