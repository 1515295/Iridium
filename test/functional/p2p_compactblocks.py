...
# TestNode: A peer we use to send messages to iridiumd, and store responses.
...
class CompactBlocksTest(IridiumTestFramework):
    ...
    # This test actually causes iridiumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that iridiumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for iridiumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # iridiumd will not send blocktxn responses for blocks whose height is
